  <?php
  	...
  	$acc_username = "JudeRibleza";
  	$acc_password = "judepogi31";
  	$acc_fullname = "Jude Demnuvar L. Ribleza";
		      		...
		      		<div class="form-group">
		      			...
		      			<?php 
		      				...
		      				elseif (isset($_SESSION['ses_username'])===true) {
		      					echo "<div class='alert alert-warning' role='alert'>Please Logout First,<a href='account.php'> click hare </a> </div>";
		      				}
